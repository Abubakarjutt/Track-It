...
/// Load, volume, set volume, and estimated-1RM trend for one exercise, plus a
/// "vs last time" row. Charts render fixed series over all available history.
